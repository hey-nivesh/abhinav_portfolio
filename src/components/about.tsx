    ...
    >
      <div className="text-center space-y-8 ">
        ...
        <div className="max-w-3xl mx-auto">
          <p className="text-base md:text-lg lg:text-xl text-white-700 leading-relaxed">
          ...
          <p className="text-base md:text-lg lg:text-xl text-white-700 leading-relaxed mt-6">
